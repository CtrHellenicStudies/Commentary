    ...
    return (
      ...
      <div className="content primary">
          ...
          <section className="page-content">
              ...
              <p>
                  Our linguistic approach in analyzing both synchronically and diachronically the formulaic system of Homeric poetry, in other words, in analyzing the system as a static phenomenon as well as an evolving one, provides an empirical foundation for the discoveries and discovery procedures that we assemble and organize in our Homer commentary. Such an approach does not ignore, however, the beauty of the verbal art that went into the making of Homeric poetry. As the four original authors of this Homer commentary, we follow the example of Roman Jakobson (in the 1960s, three of us were his students as well as Lord’s), whose research in both linguistics and literature showed that there is another side to the grammar of poetry: it is the poetry of grammar (as reflected in the title of one of his books: Jakobson 1980). The formulaic system of Homeric poetry is not a machine but a special language for expressing the sublime beauty and pleasure of hearing the ‘glories’ or <em>klea</em> of heroes and gods.
              </p>
              <p>
                  The four original authors of the basic running commentary (David Elmer, Douglas Frame, Leonard Muellner, Gregory Nagy) are all senior researchers in the field of Homeric poetry. Every paragraph of this commentary will feature an author-stamp and date-stamp. These principal authors are writing their commentary as a collaborative process, and the collaborators include a wider team of associate editors who represent two or even three younger generations of researchers who have already agreed to join the project (Maša Čulumovič, Casey Dué, Mary Ebbott, Charles de Lamberterie, Olga Levaniouk, Richard Martin, Anita Nikkanen, Yiannis Petropolous, Dan Cline, and others). The principal authors have invited their younger peers to respond to selected parts of the text that correspond to these researchers’ areas of special expertise. As in the case of the principal authors, every paragraph written by contributing authors features an author-stamp and date-stamp.
              </p>
              <h2>
                  Bibliography
              </h2>
              <p>
                  ...
                  Jakobson, R. 1980. <em>Selected Writings III: Poetry of Grammar and Grammar of Poetry</em>. Preface by S. Rudy. The Hague.
              </p>
              <p>
              ...
              <p>
                  Lord, A. B. 1960. <em>The Singer of Tales</em>. Harvard Studies in Comparative Literature 24. Cambridge, MA. See also Lord 2000.
              </p>
              <p>
              ...
              <p>
                  Saussure, F. de. 1916. <em>Cours de linguistique générale</em>. Critical ed. 1972 by T. de Mauro. Paris.
              </p>
