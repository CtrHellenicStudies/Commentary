...
class AddComment extends React.Component {
	...
	getCommentersForUser(commenters) {
		...
		commenters.forEach((commenter) => {
			if (!commentersOptions.some(val => (
				...
				if (Cookies.getItem('user').canEditCommenters.find(x => x === commenter._id) !== undefined) {
	...
	componentWillReceiveProps(newProps) {
		...
		if (Cookies.getItem('user') && Cookies.getItem('user').canEditCommenters && newProps.commentersQuery.commenters) {
			commenters = newProps.commentersQuery.commenters.filter(x => 
				Cookies.getItem('user').canEditCommenters.find(y => y === x._id));
		}
