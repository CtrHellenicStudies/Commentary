       ...
       <Card  className="user-discussion-comment paper-shadow wow fadeInUp clearfix" data-wow-duration="0.2s">
           ...
           <div className="card-content">
              <p>
               ...
               <RaisedButton className="user-discussion-comment-replies" href="/commentary/?q=work.{discussion_comment.comment.work.id}:book.{discussion_comment.comment.subwork.id}:line%20from.{discussion_comment.comment.line_from}" >
